...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        NeumorphImageButton lockButton = binding.lockButton;
        ...
        lockButton.setOnClickListener(v -> passwordShowDialog());
    ...
    private void passwordShowDialog() {
        ...
        ConstraintLayout mDialogLayout = (ConstraintLayout) inflater.inflate(R.layout.lock_dialog, null);
